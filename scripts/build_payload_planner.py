...
class PayloadControlMujocoNode:
    ...
    def payloadModel(self) -> AcadosModel:
        ...
        # Explicit Dynamics
        f_expl = ca.vertcat(
            linear_velocity, linear_acceleration, n1_dot, r1_dot, t_1_dot_cmd, r1_ddot
        )
    ...
    def solver(self, x0):
        ...
        # Cost functions
        lyapunov_position = (
            100 * (1 / 2) * self.kp_min * error_position_quad.T @ error_position_quad
            + self.kv_min
            * (1 / 2)
            * (self.mass)
            * error_velocity_quad.T
            @ error_velocity_quad
        )
        ...
        ocp.solver_options.sim_method_newton_iter = (
            20  # Newton iterations for convergence
        )
        ocp.solver_options.sim_method_newton_tol = (
            1e-10  # Newton iterations for convergence
        )
